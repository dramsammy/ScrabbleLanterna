              ...
              while(move){
                ...
                if (key1 != null && key1.getCharacter() == 's' && choices.size() != 0){
                  ...
                  while(begin){
                    ...
                    putString(0, 0, screen, "To finish your move, type in the coordinates of each piece you will use on the board in (letter,number) format (eg: (A,01,1)) MAKE SURE YOU HAVE A CAPITAL LETTER and press the enter key /");
                    ...
                    if (key2 != null && '/' == key2.getCharacter() && amount!= 0 && (coordinates.length() == 8 || coordinates.length() == 9)){
                      ...
                      if (y == 0){
                        ...
                        if (coordinates.length() == 9){
                          dir = Integer.parseInt(coordinates.substring(6,8));
                        }
                      }
                      amount--;
